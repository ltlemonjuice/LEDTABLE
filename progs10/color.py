...
while True:
	#Check if STDIN (Input) is available
	if select.select([sys.stdin], [], [], 0)[0]:
		#wenn stdin input vorhanden ist, speichere es auf input 
		input = sys.stdin.readline().strip()
		#da eine liste als String gesendet wurde, muss der string evaluiert werden
		#um Liste zu "extrahieren"
		rgbList = literal_eval(input)
		print rgbList
			
		#konvertiere Listenobjekte zurück in int
		#und zeige farbe an
